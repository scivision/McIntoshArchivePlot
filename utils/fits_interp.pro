; http://www.heliodocs.com/php/xdoc_print.php?file=$SSW/gen/idl/genutil/fits_interp.pro
...
;   	 5-Apr-2012 (N.Rich) - If input header field is type string and input is not,
;   	    	make sure field is transferred anyway (converted to type string).
;-
...
FOR i=0,nkeys-1 DO BEGIN
	...
	strnew[i] = STRTRIM( STRMID(tmp, low, len-low), 2 )
ENDFOR
;ENDIF
